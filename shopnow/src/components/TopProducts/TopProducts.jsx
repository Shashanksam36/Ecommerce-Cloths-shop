...
const ProductsData=[
    {id:1,img:Img1,title:"Casual Wear",description:"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora quam veniam odio reiciendis quia quasi explicabo ullam recusandae pariatur, modi culpa!"},
    {id:2,img:Img2,title:"Printed shirt",description:"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora quam veniam odio reiciendis quia quasi explicabo ullam recusandae pariatur, modi culpa!"},
    {id:3,img:Img3,title:"Women shirt",description:"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora quam veniam odio reiciendis quia quasi explicabo ullam recusandae pariatur, modi culpa!"},
]
    ...
    <div>
        <div className='container'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2
                md:grid-cols-3  place-items-center grap-20 md:gap-5'>
                {
