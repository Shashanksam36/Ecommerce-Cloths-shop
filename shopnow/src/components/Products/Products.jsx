...
const  ProductsData=[
    {id:1,img:Img1,title:"Women Ethnic",rating:5.5,color:"white",aosDelay:"0",},
    {id:2,img:Img2,title:"Women westeren",rating:4.5,color:"red",aosDelay:"200",},
    ...
    <div className='mt-14 mb-12'>
        <div className='container'>
            ...
            <div>
                ...
                md:grid-cols-4 lg:grid-cols-5 place-items-center grap-5'>
            {/* card section */}
            {
                ...
                <div className='flex justify-center'>
                    ...
                    rounded-md bg-primary text-white py-1 px-5'>View All Cloth Type</button>
                </div>
            </div>
        </div>
    </div>
