...
import { FaFacebook, FaInstagram, FaLinkedin, FaLocationArrow, FaMobileAlt, FaShopify } from "react-icons/fa";
            ...
            <div data-aos="zoom-in" className='grid md:grid-cols-3 pb-44 pt-5'>
                ...
                <div className='py-8 px-4'>
                    ...
                    text-justify mb-3 flex items-center gap-3'>
                        ...
                        Shopnow</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda quisquam magni maiores molestias ratione? Eius, hic! Quos nam enim ut sed?</p>
                </div>
                {/* Footer Links details */}
                <div className='grid grid-clos-2 sm:grid-cols-3
                col-span-2 md:pl-10'>
                    <div>
                        <div className='py-8 px-4'>
                            <h1
